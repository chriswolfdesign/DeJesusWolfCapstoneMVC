...
var View = /** @class */ (function () {
     ...
     */
    View.prototype.generateToolbar = function () {
    ...
    View.prototype.generateListsHTML = function (model) {
        var html = '<div style=\'height: 80vh;\'>';
        // for every list, generate the HTML
        for (var i = 0; i < model.getBoards()[0].getLists().length; i++) {
     ...
     */
    View.prototype.generateListStyle = function (list) {
        var style = '\'';
     ...
     */
    View.prototype.generateListBackgroundColor = function (list) {
        return '#999999';
    ...
    View.prototype.generateButtonHTML = function (parentID) {
